# Outliner Reordering Specification

## Purpose

Define keyboard-driven note reordering, including target resolution,
directional movement, subtree integrity, zoom boundaries, and no-op cases.
