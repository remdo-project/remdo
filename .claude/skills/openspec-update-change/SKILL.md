...
1. **If no change name provided, prompt for selection**
   ...
   Run `./tools/openspec list --json` to get available changes sorted by most recently modified. Then use the **AskUserQuestion tool** to let the user select which change to update.
