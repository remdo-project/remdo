...
[Indentation](../spec/outliner/indentation.md) defines how its commands consume
that selection.
...
| `Tab` / `Shift+Tab` | Indent / outdent the selection — see [Indentation](../spec/outliner/indentation.md). |
