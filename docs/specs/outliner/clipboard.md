...
- Single-line plain text replaces the selected text, except a URL input
  classified by [Links](./links.md) creates the corresponding note or generic
  link whose label remains the selected text.
