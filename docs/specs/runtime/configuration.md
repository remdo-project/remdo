...
Production [public shared files](../../architecture.md#gateway) use the
deployment's external public-share origin when one is configured. Otherwise they
live in `/data/public-share`.
