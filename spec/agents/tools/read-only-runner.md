...
Codex enforces repository protection through its read-only sandbox. Claude
cooperates through a runner-owned read-only instruction; its permissions are not
a security boundary.
