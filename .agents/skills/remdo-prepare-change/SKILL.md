...
Use the specification's [Lifecycle](../../../docs/specs/agents/skills/remdo-prepare-change.md#lifecycle)
for transitions and active-result contents.
...
Before preparing the specification, read
