...
export HMR_PORT VITEST_PORT VITEST_PREVIEW_PORT COLLAB_SERVER_PORT COLLAB_CLIENT_PORT PREVIEW_PORT PLAYWRIGHT_UI_PORT DOCKER_TEST_PORT PLAYWRIGHT_WEB_PORT PLAYWRIGHT_HMR_PORT
