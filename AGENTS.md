...
- `docs/todo.md` (Very long). Scratchpad for in-flight work: mark completed
  items as done while a section is active, then delete completed sections; move
  durable specs into the appropriate doc under `docs/`.
