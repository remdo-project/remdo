...
export function SelectionPlugin() {
  ...
  useEffect(() => {
    ...
    const unregisterSelectAll = editor.registerCommand(
      ...
      (event: KeyboardEvent | null) => {
        ...
        const planResult = editor
          .getEditorState()
          .read(() => $computeProgressivePlan(ladderRef, INITIAL_PROGRESSIVE_STATE, editingScopeKey));
    ...
    const $runDirectionalPlan = (direction: 'up' | 'down') => {
      ...
      const result = $computeDirectionalPlan(ladderRef, direction, INITIAL_PROGRESSIVE_STATE, editingScopeKey);
