...
- `refactor/` restructures implementation while preserving [accepted behavior](docs/documentation.md#target-behavior).
...
the repository-wide [tracked follow-up convention](docs/todo.md#tracked-follow-up).
