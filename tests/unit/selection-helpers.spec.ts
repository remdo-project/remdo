...
import { $getNoteIdOrThrow, placeCaretAtNoteId, selectRangeSelectionById } from '#tests';
...
describe('structural selection helper', () => {
  it('returns heads and slab for mixed-depth selection spanning a sibling run', async ({ remdo }) => {
    ...
    await selectRangeSelectionById(remdo, 'note2', 'note4'); // includes child note3 through note2
